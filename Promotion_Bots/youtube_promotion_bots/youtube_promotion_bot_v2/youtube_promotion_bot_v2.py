...
@client.tree.command(name="status", description="Change the bot's status (online, idle, dnd, invisible)", guild=discord.Object(id=GUILD_ID))
...
@client.tree.command(name="presence", description="Change the bot's presence (playing, streaming, listening, watching)", guild=discord.Object(id=GUILD_ID))
...
@client.tree.command(name="help", description="Display all available commands and their usage", guild=discord.Object(id=GUILD_ID))
